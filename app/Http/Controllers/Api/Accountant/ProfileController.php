...
{
    #It will show the details of the user who is logged in
    public function show()
    {
        ($accountant = Employee::find(Auth::user()->employee_id)) || $this->error('No record found!');
        $response = [
            'user'   => Auth::user(),
    ...
    #When the accountant wants to change his info he/she can change through this
    public function update(Request $request)
    {
        ($user = User::find(Auth::id())) || $this->error("User not found");
        ($employee=Employee::find(Auth::user()->employee_id))|| $this->error("Accountant not found");
