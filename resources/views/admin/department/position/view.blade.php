        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-compact">
                            ...
                            <tr>
                                ...
                                <td>{{ ucwords($job->department->name)}}</td>
                                <td class="text-right">
                                    <a class="bg-primary" title="Edit"  href="{{ route('job.edit.admin', $job->id) }}"><i class="fas fa-edit" aria-hidden="false"></i></a>
                                    <a class="bg-danger"  title="Delete" href="{{ route('job.delete.admin', $job->id) }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
                ...
                <div class="d-flex flex-row-reverse">
                    {!! $jobs->appends($_GET)->links('pagination::bootstrap-4') !!}
                </div>
            </div>
        </div>
    </div>
