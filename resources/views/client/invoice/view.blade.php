                            ...
                            <table class="table table-hover text-nowrap table-compact" id="table">
                                ...
                                @foreach($invoices as $invoice)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        data-href="{{ route('invoice.view.'.auth()->user()->user_role, $invoice->id) }}">
                                        ...
                                        <td class="text-right p-0">
                                            <a class="bg-primary list-btn"  href="{{ route('invoice.edit.'.auth()->user()->user_role, $invoice->id)  }}"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                            <a class="bg-danger list-btn"  href="{{  route('invoice.delete.'.auth()->user()->user_role, $invoice->id)  }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
