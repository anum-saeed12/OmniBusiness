...
class InvoiceController extends Controller
{
    public function index()
    {
        ...
        return view('manager.invoice.view', $data);
    }
    ...
    public function view($id) {
        ...
        return view('manager.invoice.item', $data);
    }
    ...
    public function invoice($id, Request $request) {
        ...
        return view('manager.invoice.pdf-invoice', $data);
    }
    ...
    public function printInvoice($id, Request $request) {
        ...
        return view('manager.invoice.print-invoice', $data);
    }
}
