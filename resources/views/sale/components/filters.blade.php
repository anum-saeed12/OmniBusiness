<div class="omni-filters">
    <h2>Filters</h2>
    <form action="{{ route('sale.list.'.auth()->user()->user_role) }}" method="get">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="input-group input-group-sm">
                    <input type="number" id="amount_min" min="0" name="amount_min" class="form-control" placeholder="Sale min amount" autocomplete="off" aria-autocomplete="off"  value="{{ request('amount_min') }}"/>
            ...
            <div class="col">
                ...
                <div class="input-group input-group-sm">
                    <input type="number" id="amount_max" min="0" name="amount_max" class="form-control" placeholder="Sale max amount" autocomplete="off" aria-autocomplete="off" value="{{ request('amount_max') }}"/>
                    <div class="input-group-append">
                        <div class="input-group-text">{{ isset($currency)?$currency:'PKR' }}</div>
                    </div>
                </div>
            ...
            <div class="col">
                <label class="normal">&nbsp;</label>
                <div class="input-group input-group-sm">
                    <a href="{{ route('sale.list.'.auth()->user()->user_role) }}" class="btn btn-default btn-sm btn-block">Clear filters</a>
                </div>
            </div>
        </div>
    </form>
