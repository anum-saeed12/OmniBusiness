                ...
                <div class="col-12">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-compact">
                            ...
                            <tr>
                                <td>{{ ucfirst($department->department->name) }}</td>
                                <td>{{ ucfirst($position->title) }}</td>
                                <td class="text-right p-0">
                                    <a class="bg-danger list-btn" href="{{ route('job.delete.'.auth()->user()->user_role, $position->id) }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endforeach
