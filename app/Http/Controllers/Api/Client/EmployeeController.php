...
class EmployeeController extends Controller
{
    ...
    {
        ($result = Employee::where('client_id', Auth::user()->client_id)
            ->with('user')
    ...
    public function store(Request $request)
    {
        ...
        $employee->save() || $this->error("Employee is not inserted!");
        ...
        $user               = new User($data);
        $user->save() || $this->error("Employee User is not inserted!");
    ...
    {
        ($employee = Employee::find($id)) || $this->error('No Employee found!');
        ($user = User::where('client_id',Auth::user()->client_id)
            ->where('employee_id',$id)
            ->first()) || $this->error ('No User found for Employee');
        $user->count() || $this->error("Employee User do not exist");
    ...
    public function delete($id)
    {
        $user = User::where('client_id',Auth::user()->client_id)
                ->where('employee_id',$id);
        $user->delete()|| $this->error("User of Employee is not deleted");

        ($employee = Employee::find($id))
                    ->delete() || $this->error("Employee is not deleted");
