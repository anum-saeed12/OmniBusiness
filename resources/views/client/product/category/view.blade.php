...
<section class="content">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-md-6">
                <form method="POST" action="{{ route('category.store.'.auth()->user()->user_role) }}">
                    @csrf
                    <div class="row">
                        <div class="col-8">
                            <input type="text" name="title" class="form-control" id="title" placeholder="e.g Electric" value="{{ old('title')}}">
                        </div>
                        ...
                        <table class="table table-hover text-nowrap table-compact">
                            ...
                            <tr>
                                ...
                                <td class="text-right p-0">
                                    <a class="bg-primary list-btn"  href="{{ route('category.edit.'.auth()->user()->user_role, $category->id)  }}"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                    <a class="bg-danger list-btn"  href="{{  route('category.delete.'.auth()->user()->user_role, $category->id)  }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
