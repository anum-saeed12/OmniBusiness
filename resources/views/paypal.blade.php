            ...
            <ul>
                ...
                <li class="drop-down"><a href="">Sign Up/Sign In</a>
                    <ul>
                        ...
                        <li><a href="{{ route('paypal')}}">Pay Now</a></li>
                    </ul>
                </li>
...
<main id="main" style="padding-top:100px;">
    ...
    <script>
            ...
            paypal.Buttons({
                ...
                createOrder: function(data, actions) {
                    return actions.order.create({
                        purchase_units: [{"description":"OmniBiz Managerial Solution Subscription Daily","amount":{"currency_code":"USD","value":100}}]
                    });
                },
                ...
                onApprove: function(data, actions) {
                    return actions.order.capture().then(function(orderData) {
                        ...
                        const element = document.getElementById('paypal-button-container-daily');
                        element.innerHTML = '';
        ...
        function initPayPalWeeklyButton() {
            paypal.Buttons({
                style: {
                    shape: 'rect',
                    color: 'white',
                ...
                onApprove: function(data, actions) {
                    return actions.order.capture().then(function(orderData) {
                        ...
                        // Show a success message within this page, e.g.
                        const element = document.getElementById('paypal-button-container-weekly');
                        element.innerHTML = '';
                        element.innerHTML = '<h3>Thank you for your payment!</h3>';
