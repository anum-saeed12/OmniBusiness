...
class SaleOrderController extends Controller
{
    ...
    public function view($id) {
        ...
        return view('accountant.sale.item', $data);
    }
    ...
    public function posview($id) {
        ...
        return view('accountant.sale.positem', $data);
    }
    ...
    public function posinvoice($id) {
        ...
        $pdf = PDF::loadView('accountant.sale.pos-pdf-invoice', $data);
    ...
    public function printposInvoice($id) {
        ...
        return view('accountant.sale.pos-print-invoice', $data);
    }
    ...
    public function invoice($id) {
        ...
        $date = "Invoice-". Carbon::now()->format('d-M-Y')  .".pdf";
        $pdf = PDF::loadView('accountant.sale.pdf-invoice', $data);
        return $pdf->download($date);
    }
    ...
    public function printInvoice($id) {
        ...
        return view('accountant.sale.print-invoice', $data);
    }
    ...
    public function point()
    {
        ...
        return view('accountant.sale.pointsale', $data);
    }
