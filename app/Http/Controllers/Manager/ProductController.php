...
class ProductController extends Controller
{
    ...
    {
        $products = Product::where('client_id' , Auth::user()->client_id)->with('category')->paginate($this->count);
    ...
    {
        if (!Product::find($id)) return redirect(route('product.list.manager'))->with('error', 'Product not found');
        ...
        if (!$product) return redirect(route('product.list.manager'))->with('error', 'Product not found');
