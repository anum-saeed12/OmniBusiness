...
class QuotationController extends Controller
{
    ...
    public function add()
    {
        ...
        return view('accountant.quotation.add', $data);
    }

    public function edit($id)
    {
        $quotation = Quotation::where('client_id', Auth::user()->client_id)->where('id', $id)->with('items')->get();
        ...
        return view('accountant.quotation.edit', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(
            route('quotation.add.accountant')
    ...
    public function view ( $id ) {
        ...
        return view('accountant.quotation.item', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $quotations->delete();
        return redirect(
            route('quotation.list.accountant')
    ...
    public function reject_at($id)
    {
        ...
        {
            return redirect(route('accountant.quotation.view'))
    ...
    public function accept_at($id)
    {
        ...
        {
            return redirect(route('accountant.quotation.item'))
