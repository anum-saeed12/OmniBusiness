...
<section class="content">
    <div class="container-fluid">
        @include('accountant.purchase.components.filters')
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-compact" id="table">
                            ...
                            <tr>
                                <td><a href="{{ route("purchase.view.accountant", $purchase->id) }}">{{ strtoupper(substr($purchase->purchase,6,6)) }}</a></td>

                                <td><a href="{{ route("purchase.view.accountant", $purchase->id) }}">
                                ...
                                <td><a href="{{ route("purchase.view.accountant", $purchase->id) }}">{{ $currency }}{{ number_format($purchase->total_amount) }}</a></td>

                                <td><a href="{{ route("purchase.view.accountant", $purchase->id) }}">{{\Carbon\Carbon::createFromTimeStamp(strtotime($purchase->due_date))->format('d-M-Y')}} </a></td>
                                <td><a href="{{ route("purchase.view.accountant", $purchase->id) }}">
                                ...
                                {{--<td class="text-right p-0">
                                    <a class="bg-primary list-btn"  href="{{ route('purchase.edit.accountant', $purchase->id)  }}"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                    <a class="bg-danger list-btn"  href="{{  route('purchase.delete.accountant', $purchase->id)  }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>--}}
                            </tr>
                            @endforeach
                            </tbody>
