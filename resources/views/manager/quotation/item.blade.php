                                ...
                                <div class="row invoice-info">
                                    ...
                                    <div class="col-sm-4 invoice-col">
                                        ...
                                        @if($quotation->accepted_at == NULL && $quotation->rejected_at == NULL )
                                            ...
                                            <br><br>
                                            <form action="#" method="post" id="_formAccept">@csrf</form>
                                            <form action="#" method="post" id="_formReject">@csrf</form>

                                            <a class="btn btn-success" onclick="$('#_formAccept').submit();return false;" style="top:3px; color:white" href="#">Accept Now</a>
                                            <a class="btn btn-danger" onclick="$('#_formReject').submit();return false;" style="top:3px; color:white" href="#">Reject Now</a>
                                        @endif
