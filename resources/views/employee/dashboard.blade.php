        ...
        <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-white">
                        ...
                        <a href="{{ route('sale.list.employee') }}" class="small-box-footer bg-info"  style="color:white!important;">See all <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-white">
                        ...
                        <a href="{{ route('purchase.list.employee') }}"  class="small-box-footer bg-warning"  style="color:white!important;">See all <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
        </div>
    </div>
