...
class EmployeeController extends Controller
{
    ...
    {
        ($employees= User::where('client_id', Auth::user()->client_id)
    ...
    public function view($id)
    {
        ...
        if (!Employee::find($id)) return redirect(route('employee.list.manager'))->with('error', 'Employee not found');
        ...
        if (!$employee) return redirect(route('employee.list.manager'))->with('error', 'Employee not found');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'password'              => 'required',
            'user_role'             => 'required|in:accountant,employee',
    ...
    public function update(Request $request, $id)
    {
        ...
        $employee->employee['updated_by']  = Auth::user()->employee_id;
