                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            @if($employee->sales->total)
                                <li class="list-group-item">
                                    <b>Total Sales</b> <p class="float-right m-0">{{ $employee->sales->total }} <small><a href="{{ route('sale.list.'.auth()->user()->user_role) }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                                @if($employee->purchases->total)
                                    <li class="list-group-item">
                                        <b>Total Purchases</b> <p class="float-right m-0">{{ $employee->purchases->total }} <small><a href="{{ route('purchase.list.'.auth()->user()->user_role) }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                    </li>
                                @endif
                            @if(!empty($employee->invoices->total))
                                <li class="list-group-item">
                                    <b>Invoices</b> <p class="float-right m-0">{{ $employee->invoices->total }} <small><a href="{{ route('invoice.list.'.auth()->user()->user_role) }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                            @if(!empty($employee->quotations->total))
                                <li class="list-group-item">
                                    <b>Quotations</b> <p class="float-right m-0">{{ $employee->quotations->total }} <small><a href="{{ route('quotation.list.'.auth()->user()->user_role) }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                        ...
                                        @if(count($sales))
                                            @foreach($sales as $sale)
                                                <div class="timeline-item mb-2">
                                                    ...
                                                    <h3 class="timeline-header"><b><a href="{{ route('sale.view.'.auth()->user()->user_role,$sale->id) }}">New Sale Order</a></b> generated</h3>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="timeline-item mb-2">
                                        ...
                                        @if(count($purchases))
                                            @foreach($purchases as $purchase)
                                                <div class="timeline-item mb-2">
                                                    ...
                                                    <h3 class="timeline-header"><b><a href="{{ route('purchase.view.'.auth()->user()->user_role,$purchase->id) }}">New Purchase Order</a></b> generated</h3>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="timeline-item mb-2">
                                        ...
                                        @if(count($quotations))
                                            @foreach($quotations as $quotation)
                                                <div class="timeline-item mb-2">
                                                    ...
                                                    <h3 class="timeline-header"><b><a href="{{ route('quotation.view.'.auth()->user()->user_role,$quotation->id) }}">New Quotation </a></b> generated</h3>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="timeline-item mb-2">
                                        ...
                                        @if(count($invoices))
                                            @foreach($invoices as $invoice)
                                                <div class="timeline-item mb-2">
                                                    ...
                                                    <h3 class="timeline-header"><b><a href="{{ route('invoice.view.'.auth()->user()->user_role,$invoice->id) }}">New Invoice</a></b> generated</h3>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="timeline-item mb-2">
                            ...
                            <div class="tab-pane" id="profile">
                                <form class="form-horizontal" action="{{ route('employee.update.'.auth()->user()->user_role,$employee->employee_id) }}" method="post">
                                   @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card card-primary">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <select name="user_role" class="form-control" id="user_role">
                                                                <option value="manager" {{ $employee->user_role == 'manager' ? 'selected="selected"' : '' }}>Manager
                                                                </option>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select name="position_id" class="form-control" id="position_id">
                                                                @foreach ($positions as $position)
                                                                    <option value="{{ $position->id }}" {{ $position->id == $employee->employee->position_id ? ' selected="selected" ' : '' }}> {{ucfirst( $position->title) }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-6">
