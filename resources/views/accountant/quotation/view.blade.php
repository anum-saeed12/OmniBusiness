                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-compact" id="table">
                            ...
                            <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                data-href="{{ route('quotation.view.accountant', $quotation->id) }}">
                                <td><a href="{{ route('quotation.view.accountant', $quotation->id) }}">{{ sprintf("%05d",$quotation->id) }}</a></td>
                                <td><a href="{{ route('quotation.view.accountant', $quotation->id) }}">{{
                                ...
                                <td><a href="{{ route('quotation.view.accountant', $quotation->id) }}">@if( $quotation->employee_id != Null)
                                ...
                                <td><a href="{{ route('quotation.view.accountant', $quotation->id) }}">{{ $currency }}{{ number_format($quotation->total_amount) }}</a></td>
                                <td><a href="{{ route('quotation.view.accountant', $quotation->id) }}">
                                ...
                                <td class="text-center"><a href="{{ route('quotation.view.accountant', $quotation->id) }}">
                                    @if(!empty($quotation->accepted_at))
                                    <span class="text-bold text-success"><i
                                            class="fas fa-check-circle text-success"></i> Accepted</span>
