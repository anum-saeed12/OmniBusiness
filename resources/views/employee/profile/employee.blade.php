                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            @if($employee->sales->total)
                                <li class="list-group-item">
                                    <b>Total Sales</b> <p class="float-right m-0">{{ $employee->sales->total }} <small><a href="{{ route('sale.list.employee') }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                                @if($employee->purchases->total)
                                    <li class="list-group-item">
                                        <b>Total Purchases</b> <p class="float-right m-0">{{ $employee->purchases->total }} <small><a href="{{ route('purchase.list.employee') }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                    </li>
                                @endif
                            @if(!empty($employee->invoices->total))
                                <li class="list-group-item">
                                    <b>Invoices</b> <p class="float-right m-0">{{ $employee->invoices->total }} <small><a href="{{ route('invoice.list.employee') }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                            @if(!empty($employee->quotations->total))
                                <li class="list-group-item">
                                    <b>Quotations</b> <p class="float-right m-0">{{ $employee->quotations->total }} <small><a href="{{ route('quotation.list.employee') }}?employee={{ $employee->data->id }}" class="ml-3">View all</a></small></p>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile">
                                <form class="form-horizontal" action="{{ route('profile.update.employee',$employee->employee_id) }}" method="post">
                                   @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <input type="text" name="username" class="form-control text-muted"
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <input type="email" name="email" class="form-control"
                                                                   ...
                                                                   placeholder="Enter Company Email" disabled>
