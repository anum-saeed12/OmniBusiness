...
class ProductController extends Controller
{
    ...
    {
        $product = Product::where('client_id' , Auth::user()->client_id)->get();
        $product || $this->error('No product is available');
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'category_id'=> 'required|numeric|exists:App\Models\ProductCategory,id'
        ...
        $category->save() || $this->error("Product and Category is not inserted!");
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            'name'      => 'sometimes|required|exists:App\Models\Product,name',
