...
<div class="container-fluid sansserif" id="invoice">
    <br/><br/>
   <hr style="height:30px;border-width:30px;color:#92c33c;background-color:#92c33c">
    <br/><br/>
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <br>
                                <b>Purchase Ref:</b> {{ strtoupper(substr($invoice->purchase->purchase,-6,6)) }}-{{ sprintf("%04d", $invoice->purchase->id) }}<br>
                                <b>Due Date:</b> {{ $invoice->purchase->due_date_formatted }}<br>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div>
        <span class="triangle_bottom_left float-left"></span><span class="triangle_bottom_right float-right"></span></div>
    <hr style="height:30px;border-width:30px;color:#92c33c;background-color:#92c33c">
</div>
<br/><br/>
<!-- jQuery -->
