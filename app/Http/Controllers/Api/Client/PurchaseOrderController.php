...
class PurchaseOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $sale = $this->all
            ?
            Purchase::where('client_id', $client_id)->orderBy('id', 'DESC')->with('items')->get()
            :
            Purchase::where('client_id', $client_id)->where('employee_id', null)->orderBy('id', 'DESC')->with('items')->get();

        $sale->count() || $this->error('No purchase order available');
