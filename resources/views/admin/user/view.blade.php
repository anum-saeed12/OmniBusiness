                        ...
                        <table class="table table-hover text-nowrap table-compact ">
                            ...
                            <tr>
                                ...
                                <td class="text-right p-0">
                                    <a class="bg-primary list-btn"  href="{{ route('user.edit.admin', $user->id) }}"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                    <a class="bg-danger list-btn"  href="{{ route('user.delete.admin', $user->id) }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
