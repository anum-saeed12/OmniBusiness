    ...
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane show active" id="nav-pos" role="tabpanel" aria-labelledby="nav-pos-tab"><div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <form class="form-horizontal" action="{{ route('sale.store.'.auth()->user()->user_role) }}" method="post">
                                @csrf
            ...
            <div class="tab-pane " id="nav-sale" role="tabpanel" aria-labelledby="nav-sale-tab"><div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <form class="form-horizontal" action="{{ route('sale.pos.'.auth()->user()->user_role) }}" method="post">
                                @csrf
                                <div class="card-body pb-0">
                                    <div class="row">
                                        <div class="col-sm-6">
