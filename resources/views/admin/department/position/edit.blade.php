        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    <form class="form-horizontal" action="{{ route('job.update.admin',$position->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                           placeholder="Enter Job Position " value="{{ ucfirst($position->title) }}" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="department_id" id="department_id" class="form-control">
                                        ...
                                        <option value="{{ $department->id }}" {{ $department->id ==
                                            $position->department_id ? ' selected="selected" ' : '' }}> {{
