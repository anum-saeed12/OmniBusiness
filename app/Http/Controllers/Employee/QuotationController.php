...
class QuotationController extends Controller
{
    public function index()
    {
        ...
        $quotations = $this->all
            ...
            Quotation::select('quotations.*')
                ...
                ->where('quotations.employee_id', Auth::user()->employee_id)
    ...
    public function add()
    {
        ...
        return view('employee.quotation.add', $data);
    }
    ...
    public function view ( $id ) {
        ...
        return view('employee.quotation.item', $data);
    }
