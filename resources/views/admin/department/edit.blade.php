...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <form method="POST" action="{{ route('department.update.admin',$department->id) }}">
                    @csrf
                    <div class="form-group row">
                        <div class="col-sm-9">
                            <input type="text" name="name" class="form-control" id="name"
                                   placeholder="New Department Name" value="{{$department->name}}" required>
                        ...
                        <table class="table table-hover text-nowrap table-compact">
                            ...
                            @foreach($departments as $department)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="text-primary m-2 mb-0 mt-0 ml-0"  href="{{ route('department.edit.admin', $department->id) }}"><i class="fas fa-edit" aria-hidden="false"></i></a>
                                        <a class="text-danger"  href="{{ route('department.delete.admin', $department->id) }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
