        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    <form class="form-horizontal" action="{{ route('vendor.store.'.auth()->user()->user_role) }}" method="POST">
                        @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="phone_num" class="form-control" id="phone_num"
                                           placeholder="00000000000000" value="{{ old('phone_num') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="email" name="personal_email" class="form-control" id="personal_email"
                                           placeholder="Example-admin@omni.com" value="{{ old('personal_email') }}">
