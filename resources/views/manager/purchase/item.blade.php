...
<section class="content">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12">
                <a href="{{ route('purchase.invoice.print.manager', $purchase->invoice_id) }}" type="submit" class="btn btn-info toastrDefaultSuccess mr-2 btn-sm" target="btnActionIframe"><i class="fa fa-print mr-1"></i> Print Invoice</a>
                <a href="{{ route('purchase.invoice.manager', $purchase->invoice_id) }}" type="submit" class="btn btn-info toastrDefaultSuccess btn-sm" target="btnActionIframe"><i class="far fa-file-alt mr-1"></i> Create Invoice Pdf</a>
                                    ...
                                    <div class="table-responsive table-sm">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>{{ $currency }}{{number_format($purchase->total_amount - (($purchase->gst/100) * $purchase->total_amount)) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Tax ({{$gst}}%)</th>
