                ...
                <div class="card">
                    ...
                    <div class="row mb-3 mt-3 ml-3">
                        ...
                        <div class="col-md-6 text-right pr-md-4">
                            ...
                            <a href="{{ route('purchase.add.client') }}" class="btn btn-success"><i class="fa fa-plus-circle mr-1"></i> Add New</a>
                        </div>
                    </div>
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-compact" id="table">
                            ...
                            <tr>
                                <td><a href="{{ route("purchase.view.client", $purchase->id) }}">{{ strtoupper(substr($purchase->purchase,6,6)) }}</a></td>

                                <td><a href="{{ route("purchase.view.client", $purchase->id) }}">
                                ...
                                <td><a href="{{ route("purchase.view.client", $purchase->id) }}">{{ $currency }}{{ number_format($purchase->total_amount) }}</a></td>

                                <td><a href="{{ route("purchase.view.client", $purchase->id) }}">{{\Carbon\Carbon::createFromTimeStamp(strtotime($purchase->due_date))->format('d-M-Y')}} </a></td>
                                <td><a href="{{ route("purchase.view.client", $purchase->id) }}">
                                ...
                                {{--<td class="text-right p-0">
                                    <a class="bg-primary list-btn"  href="{{ route('purchase.edit.client', $purchase->id)  }}"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                    <a class="bg-danger list-btn"  href="{{  route('purchase.delete.client', $purchase->id)  }}"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                </td>--}}
                            </tr>
                            @endforeach
                            </tbody>
