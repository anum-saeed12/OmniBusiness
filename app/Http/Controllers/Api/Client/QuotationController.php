    ...
    public function store(Request $request)
    {
       ...
       /* $data                   = $request->all();
        ...
        foreach ($order_items as $item) {
            $order_items['quotation_id']     = $id;
            $order_items['product_id']  = $item->product_id;
            $order_items['quantity']    = $item->quantity;
            $order_items['unit_price']  = $item->unit_price;
            $quotations                  = new QuotationItem($order_items);
            $quotations->save() || $this->error('Sale Order not inserted');
        }
