            ...
            <div class="col-md-3">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Total Sales</b> <a class="float-right">543</a>
                            </li>
                            <li class="list-group-item">
                                <b>Total Purchase</b> <a class="float-right">13,287</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.card-body -->
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">{{$profile->license}}</p>

                        <hr>

                        <strong><i class="far fa-file-alt mr-1"></i> Overview</strong>

                        <p class="text-muted">{{$profile->overview}}</p>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
